...
W1 = np.random.randn(3, neurons) * 0.5  # input -> hidden
W2 = np.random.randn(neurons+1, 1) * 0.5  # hidden -> output
...
# -------------------
# Animation (lines + loss side by side)
# -------------------
...
ax1.set_title("3 Hidden Neurons")
ax1.legend()
neuron_lines = []
